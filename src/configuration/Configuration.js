...
const Configuration = ({ theme, locale, changeTheme, changeLocale, translate }) => (
    <Card>
        ...
        <CardText>
            ...
            <RaisedButton style={styles.button} label="zh" primary={locale === 'zh'} onClick={() => changeLocale('zh')} />
            <RaisedButton style={styles.button} label="en" secondary={locale === 'en'} onClick={() => changeLocale('en')} />
        </CardText>
    </Card>
);
